                        ...
                        <table class="tf-table-page-cart">
                            ...
                            <tr class="tf-cart-item file-delete">
                                <td class="tf-cart-item_product">
                                    <a href="{{url('product-detail/id=1')}}" class="img-box">
                                        <img src="{{asset('assets/images/products/orange-1.jpg')}}" alt="img-product">
                                    </a>
                                    <div class="cart-info">
                                        <a href="{{url('product-detail/id=1')}}" class="cart-title link">Oversized Printed T-shirt</a>
                            ...
                            <tr class="tf-cart-item file-delete">
                                <td class="tf-cart-item_product">
                                    ...
                                    <div class="cart-info">
                                        <a href="{{url('product-detail/id=1')}}" class="cart-title link">Ribbed Tank Top</a>
                            ...
                            <tr class="tf-cart-item file-delete">
                                <td class="tf-cart-item_product">
                                    <a href="{{url('product-detail/id=1')}}" class="img-box">
                                        <img src="{{asset('assets/images/products/black-4.jpg')}}" alt="img-product">
                                    </a>
                                    <div class="cart-info">
                                        <a href="{{url('product-detail/id=1')}}" class="cart-title link">Regular Fit Oxford Shirt</a>
                                ...
                                <div class="product">
                                    ...
                                    <div class="content-wrap">
                                        <div class="product-title">
                                            <a href="{{url('product-detail/id=1')}}">Jersey thong body</a>
                                        </div>
                                        <div class="price">$105.95</div>
                                    </div>
                                    <a href="{{url('product-detail/id=1')}}" class=""><i class="icon-arrow1-top-left"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial-item style-column">
                                ...
                                <div class="author">
                                    ...
                                    <div class="metas"><span>Customer from France </span></div>
                                </div>
                                <div class="product">
                                    <div class="image">
                                        <a href="{{url('product-detail/id=1')}}">
                                    ...
                                    <div class="content-wrap">
                                        <div class="product-title">
                                            <a href="{{url('product-detail/id=1')}}">Cotton jersey top</a>
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item style-column">
                                ...
                                <div class="product">
                                    ...
                                    <div class="content-wrap">
                                        <div class="product-title">
                                            <a href="{{url('product-detail/id=1')}}">Ribbed modal T-shirt</a>
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item style-column">
                                ...
                                <div class="author">
                                    ...
                                    <div class="metas"><span>Customer from Japan</span></div>
                                </div>
                                <div class="product">
                                    <div class="image">
                                        <a href="{{url('product-detail/id=1')}}">
                                    ...
                                    <div class="content-wrap">
                                        <div class="product-title">
                                            <a href="{{url('product-detail/id=1')}}">Customer from Japan</a>
                                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                <div class="card-product-wrapper">
                                    <a href="{{url('product-detail/id=1')}}" class="product-img">
                                ...
                                <div class="card-product-info">
                                    <a href="{{url('product-detail/id=1')}}" class="title link">Ribbed Tank Top</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{url('product-detail/id=1')}}" class="title link">Ribbed modal T-shirt</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{url('product-detail/id=1')}}" class="title link">Oversized Printed T-shirt</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{url('product-detail/id=1')}}" class="title">Oversized Printed T-shirt</a>
                                    <span class="price">$16.95</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">White</span>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{url('product-detail/id=1')}}" class="title link">V-neck linen T-shirt</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{url('product-detail/id=1')}}" class="title link">Loose Fit Sweatshirt</a>
                                    <span class="price">$10.00</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Light Green</span>
