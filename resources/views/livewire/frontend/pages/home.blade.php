                            ...
                            <div class="card-product">
                                <div class="card-product-wrapper">
                                    <a href="{{ route('product-details', $product->id) }}" class="product-img">
                                        <img class=" img-product" data-src="{{$product->image_name}}" src="{{$product->image_name}}" alt="image-product">
                                        <img class="img-hover" data-src="{{$product->image_name}}" src="{{$product->image_name}}" alt="image-product">
                                    </a>
