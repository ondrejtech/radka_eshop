                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-men.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{asset('assets/images/collections/collection-1.jpg')}}" src="{{asset('assets/images/collections/collection-1.jpg')}}" alt="collection-demo-1">
                                                            </a>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-women.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{asset('assets/images/collections/collection-2.jpg')}}" src="{{asset('assets/images/collections/collection-2.jpg')}}" alt="collection-demo-1">
                                                            </a>
                                                            <div class="collection-content">
