                ...
                <div class="tf-shop-content">
                    <div class="grid-layout wrapper-shop" data-grid="grid-3">
                        ...
                        <div class="card-product">
                            ...
                            <div class="card-product-info">
                                <a href="{{route('product-detail')}}" class="title link">Regular Fit Oxford Shirt</a>
                                <span class="price">$10.00</span>
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="tooltip">Black</span>
                        ...
                        <div class="card-product">
                            ...
                            <div class="card-product-info">
                                <a href="{{route('product-detail')}}" class="title link">Loose Fit Hoodie</a>
                        ...
                        <div class="card-product">
                            ...
                            <div class="card-product-info">
                                <a href="{{route('product-detail')}}" class="title link">Patterned scarf</a>
                        ...
                        <div class="card-product">
                            ...
                            <div class="card-product-info">
                                <a href="{{route('product-detail')}}" class="title link">Slim Fit Fine-knit Turtleneck Sweater</a>
