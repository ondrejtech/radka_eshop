                                ...
                                <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                    <div class="swiper-wrapper stagger-wrap">
                                        ...
                                        <div class="swiper-slide stagger-item" data-color="beige">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod31.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod31.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="beige">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="beige">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod2.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod2.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="beige">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod3.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod3.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="beige">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod4.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod4.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="beige">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/')}}" src="{{asset('assets/')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <!-- black -->
                                        <div class="swiper-slide stagger-item" data-color="black">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod6.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod6.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="black">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod7.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod7.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="black">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod8.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod8.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="black">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod9.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod9.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <!-- blue -->
                                        <div class="swiper-slide stagger-item" data-color="blue">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod10.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod10.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="blue">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod11.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod11.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="blue">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod12.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod12.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="blue">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod13.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod13.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <!-- white -->
                                        <div class="swiper-slide stagger-item" data-color="white">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod14.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod14.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="white">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod15.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod15.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="white">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod16.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod16.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="white">
                                            <div class="item">
                                                <img class="lazyload" data-src="{{asset('assets/images/shop/products/hmgoepprod17.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod17.jpg')}}" alt="img-product">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                    <div class="swiper-wrapper" >
                                        ...
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{asset('assets/images/shop/products/p-d1.png')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="{{asset('assets/images/shop/products/hmgoepprod31.jpg')}}" data-src="{{asset('assets/images/shop/products/hmgoepprod31.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod31.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="{{asset('assets/images/shop/products/hmgoepprod.jpg')}}" data-src="{{asset('assets/images/shop/products/hmgoepprod.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod2.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="{{asset('assets/images/shop/products/hmgoepprod2.jpg')}}" data-src="{{asset('assets/images/shop/products/hmgoepprod2.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod2.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod3.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod3.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod3.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod3.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod4.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod4.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod4.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod4.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="beige">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod5.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod5.jpg" data-src="{{asset('assets/')}}" src="{{asset('assets/')}}" alt="">
                                            </a>
                                        </div>
                                        <!-- black -->
                                        <div class="swiper-slide" data-color="black">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod6.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="{{asset('assets/images/shop/products/hmgoepprod6.jpg')}}" data-src="{{asset('assets/images/shop/products/hmgoepprod6.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod6.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="black">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod7.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod7.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod7.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod7.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="black">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod8.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod8.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod8.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod8.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="black">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod9.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod9.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod9.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod9.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <!-- blue -->
                                        <div class="swiper-slide" data-color="blue">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod10.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod10.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod10.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod10.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="blue">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod11.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod11.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod11.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod11.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="blue">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod12.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod12.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod12.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod12.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="blue">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod13.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod13.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod13.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod13.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                        <!-- white -->
                                        <div class="swiper-slide" data-color="white">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod14.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod14.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod14.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod14.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="white">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod15.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod15.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod15.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod15.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="white">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod16.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod16.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod16.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod16.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                        <div class="swiper-slide" data-color="white">
                                            <a href="{{asset('assets/images/shop/products/hmgoepprod17.jpg')}}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod17.jpg" data-src="{{asset('assets/images/shop/products/hmgoepprod17.jpg')}}" src="{{asset('assets/images/shop/products/hmgoepprod17.jpg')}}" alt="img-product">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="tf-product-info-list other-image-zoom">
                                ...
                                <div class="tf-product-info-buy-button">
                                    <form class="">
                                        ...
                                        <div class="w-100">
                                            <a href="{{url('shopping-cart/id=1')}}" class="btns-full">Shopping cart</a>
{{--                                            <a href="#" class="payment-more-option">More payment options</a>--}}
                                ...
                                <div class="tf-product-info-extra-link">
                                    <a href="#compare_color" data-bs-toggle="modal" class="tf-product-extra-icon">
                                        <div class="icon">
                                            <img src="{{asset('assets/images/item/compare.svg')}}" alt="">
                                        </div>
                ...
                <div class="tf-height-observer w-100 d-flex align-items-center">
                    <div class="tf-sticky-atc-product d-flex align-items-center">
                        <div class="tf-sticky-atc-img">
                            <img class="lazyloaded" data-src="{{asset('assets/images/shop/products/p-d1.png')}}" alt="" src="{{asset('assets/images/shop/products/p-d1.png')}}">
                        </div>
                                    ...
                                    <div class="reply-comment cancel-review-wrap">
                                        ...
                                        <div class="reply-comment-wrap">
                                            <div class="reply-comment-item">
                                                <div class="user">
                                                    <div class="image">
                                                        <img src="{{asset('assets/images/collections/collection-circle-9.jpg')}}" alt="">
                                                    </div>
                                                    <div>
                                                        <h6>
                                            ...
                                            <div class="reply-comment-item type-reply">
                                                <div class="user">
                                                    <div class="image">
                                                        <img src="{{asset('assets/images/collections/collection-circle-10.jpg')}}" alt="">
                                                    </div>
                                                    <div>
                                                        <h6>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{route('product-detail')}}" class="title link">Ribbed modal T-shirt</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{route('product-detail')}}" class="title link">Oversized Printed T-shirt</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{route('product-detail')}}" class="title">Oversized Printed T-shirt</a>
                                    <span class="price">$16.95</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">White</span>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{route('product-detail')}}" class="title link">V-neck linen T-shirt</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{route('product-detail')}}" class="title link">Loose Fit Sweatshirt</a>
                                    <span class="price">$10.00</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Light Green</span>
                                            <span class="swatch-value bg_light-green"></span>
                                            <img class="lazyload" data-src="{{asset('assets/light-green-1.jpg')}}" src="{{asset('assets/light-green-1.jpg')}}" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="{{route('product-detail')}}" class="title link">Ribbed Tank Top</a>
                                    <span class="price">$16.95</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Orange</span>
